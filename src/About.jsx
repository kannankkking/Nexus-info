...
const About = () => {
    ...
    return (
        <div>
            ...
            <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% flex flex-col items-center justify-center gap-10 h-[550px] p-4">
                <h1 className='text-4xl md:text-6xl text-center text-white mt-10 md:mt-36'>About Us</h1>
                <p className='text-center text-white text-lg md:text-xl max-w-2xl'>
                    At Techy Software, we are a passionate team of tech enthusiasts dedicated to empowering businesses in the digital landscape. Founded in [Year], our mission is to provide innovative solutions that enhance online presence and drive growth.
                </p>
            </div>
