        ...
        <div>
            ...
            <div>
                <div className="bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90% ... flex flex-col gap-10 h-[550px]">
                    ...
                    <Link to='#form'>  <button className='w-28 p-1 bg-transparent border ml-[600px] text-xl text-white rounded-xl hover:bg-white hover:text-black hover:scale-90 transition-all'>Reach Us</button></Link>
                </div>
            </div>
            ...
            <div className='bg-gray-100'>
                ...
                <div className="mx-10 form ">
                    <form className="flex flex-col w-96 gap-8 " action="">
                        ...
                        <button className="bg-blue-800 p-2 mt-5 rounded-md w-20 text-white hover:-translate-y-2 transition hover:text-black">Send</button>
                    </form>
                </div>
            </div>
